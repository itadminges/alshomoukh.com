  ...
  return (
    <AcademicSubPageLayout
      ...
      detailSections={[
        ...
        {
          title: "International Advanced Level (IAL) Programme (Grades 11–12)",
          paragraphs: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Develops leadership, communication, teamwork, research, analytical thinking, and project management skills.",
